<nav x-data="{ open: false, darkMode: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="-mr-2 flex items-center sm:hidden">
                ...
                <button @click="darkMode = !darkMode" class="mr-2 p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700">
