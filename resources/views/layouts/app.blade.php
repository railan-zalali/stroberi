...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 transition-colors duration-200">
    ...
    <div class="min-h-screen">
        ...
        <!-- Page Heading -->
        @if (isset($header))
            <header class="bg-white dark:bg-gray-900 shadow dark:border-b dark:border-gray-800 transition-colors duration-200">
        ...
        <div x-data="{ showToast: false, message: '', type: 'success' }" x-init="@if (session('success')) showToast = true;
    ...
    @elseif(session('error'))
        ...
        type = 'error';
        setTimeout(() => showToast = false, 3000); @endif">
            <div x-show="showToast" x-transition:enter="transition ease-out duration-300"
                ...
                <div class="flex items-center text-white">
                    <svg x-show="type === 'success'" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <svg x-show="type === 'error'" class="h-6 w-6 mr-2" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
