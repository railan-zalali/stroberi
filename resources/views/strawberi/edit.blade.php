        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <div class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded text-sm">
                        ...
                        <span
                            class="px-2 py-1 rounded text-xs font-bold {{ $paymentStatus == 'Sudah Dibayar' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                            {{ $paymentStatus }}
                        </span>
                    </div>

                    @if (isset($lockedBecausePaidAndZero) && $lockedBecausePaidAndZero)
                        <div class="mb-6 bg-red-50 border border-red-200 text-red-800 p-4 rounded">
                            Stok ini terkunci permanen karena sudah dibayar dan stok habis. Tidak dapat dilakukan
                            perubahan.
                        </div>
                    @endif
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="mt-1">
                                        <input type="number" step="0.01"
                                            value="{{ number_format($strawberi->jumlah, 2) }}"
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Jumlah dasar pembelian tidak dapat diubah di sini.
                                        Gunakan bagian "Penyesuaian Stok" di bawah untuk mengubah stok berjalan.</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">
                                        Otomatis dihitung: Segar (2 hari), Beku (1 bulan) dari tanggal masuk. Dapat diubah
            ...
            <div class="mt-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 border-b border-gray-200">
                    ...
                    <p class="text-sm text-gray-600 mb-4">Gunakan penyesuaian untuk mengubah nilai stok berjalan tanpa
                        mengubah jumlah dasar pembelian.</p>
                    @unless ($strawberi->is_posted)
                        <form method="POST" action="{{ route('strawberi.adjust', $strawberi) }}" class="space-y-4">
                            @csrf
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="adjust_quantity" class="block text-sm font-medium text-gray-700">Jumlah
                                        Penyesuaian (kg)</label>
                                    <input type="number" step="0.01" name="adjust_quantity" id="adjust_quantity"
                                        required
